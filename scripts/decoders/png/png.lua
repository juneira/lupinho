local class = require 'decoders.png.30log'
local deflate = require 'decoders.png.deflate'
local Stream = require 'decoders.png.stream'

local ch, imStr, bpp, bpl, pngImage, PLTE, IDAT
